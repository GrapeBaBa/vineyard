...
/**
 * Tcp server implementation for transport.
 *
 * @param <R>
 * @param <W>
 */
public final class VineyardServerImpl<R, W> extends VineyardServer<R, W> {
    ...
    @Override
    public <RR, WW> VineyardServer<RR, WW> addChannelHandlerFirst(
    ...
    @Override
    public <RR, WW> VineyardServer<RR, WW> addChannelHandlerLast(
            EventExecutorGroup group, String name, Func0<ChannelHandler> handlerFactory) {
        return copy(VineyardServerImpl.<RR, WW>castServer(server.addChannelHandlerLast(group, name, handlerFactory)));
    }

    @Override
    public <RR, WW> VineyardServer<RR, WW> addChannelHandlerBefore(
            String baseName, String name, Func0<ChannelHandler> handlerFactory) {
        return copy(VineyardServerImpl.<RR, WW>castServer(server.addChannelHandlerBefore(
                baseName, name, handlerFactory)));
    }
    ...
    @Override
    public <RR, WW> VineyardServer<RR, WW> addChannelHandlerAfter(
            String baseName, String name, Func0<ChannelHandler> handlerFactory) {
        return copy(VineyardServerImpl.<RR, WW>castServer(server.addChannelHandlerAfter(
                baseName, name, handlerFactory)));
    }
